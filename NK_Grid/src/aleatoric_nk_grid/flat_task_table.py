...
from .config import (
    NKGridConfig, config_from_json, config_to_json as _config_to_json,
)
from .resources import ResourceRequest, sbatch_resource_args
from .task_table import (
    GROUP_PREPROCESS_MODES,
    TABLE_COLUMNS,
    TABLE_FORMAT_VERSION,
    TASK_TABLE_ROWS_PER_GROUP_MAX,
    TaskRow,
    TaskTableSummary,
    _arrow_table,
    _durable_replace,
    ...
    _row_id,
    _task_rows,
    _task_table_schema_fingerprint,
    _validate_task_table_columns,
    _write_table_groups,
    assign_rows_modulo,
    build_rows,
    execution_groups,
...
def _config_from_json(payload: Mapping[str, object]) -> NKGridConfig:
    return config_from_json(payload, strict=True)
