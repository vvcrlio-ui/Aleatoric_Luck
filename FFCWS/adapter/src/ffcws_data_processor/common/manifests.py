...
def feature_row(
    ...
    *,
    ...
    return {
        ...
        "kind": feature.kind,
        "strategy": strategy,
        "keep": bool(feature.keep if force_keep is None else force_keep),
        "reason": (
            feature.reason
            if force_keep is None or force_keep == feature.keep
            else "v5_contract_override"
        ),
        "source_order": source.source_order if source_order is None else source_order,
